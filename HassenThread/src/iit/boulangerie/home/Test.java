...
public class Test {
	...
	public static void main(String[] args) {
		...
		Vendeur vendeur1 = new Vendeur(panier);
		Vendeur vendeur2 = new Vendeur(panier);
		Vendeur vendeur3 = new Vendeur(panier);
		...
		Thread v1 = new Thread(vendeur1);
		Thread v2 = new Thread(vendeur2);
		Thread v3 = new Thread(vendeur3);
